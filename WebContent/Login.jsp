				...
				<div class="col-sm-12">
					<ul class="breadcrumb" itemtype="http://schema.org/BreadcrumbList">
						<li itemprop="itemListElement" itemtype="http://schema.org/ListItem">
							<a itemprop="item" href="http://localhost:8080/Web_Ban_Sach/"> 
								<span itemprop="name"> <i class="fa fa-home"></i> Trang chủ</span>
							</a> <span><i class="fa fa-angle-right"></i></span>
							<meta itemprop="position" content="1">
						</li>
						<li itemprop="itemListElement" itemtype="http://schema.org/ListItem">
							<a itemprop="item" href="http://localhost:8080/Web_Ban_Sach/Login.jsp">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="board">
								...
								<span>
									<strong>Tại sao không đăng kí thành viên?</strong>
								</span>
								<br>
								<span>Thành viên có thể trải nghiệm và 
								được thông báo một cách sớm nhất những
								chương trình khuyến mãi cũng như những 
								đầu sách đang hot hiện nay.</span>
								<br><br>
								<a href="http://localhost:8080/Web_Ban_Sach/SignUp.jsp"
							...
							<div class="board">
								...
								<form action="login" method="POST">
									<div class="form-group">
										<label class="control-label" for="nameLogin">Tên đăng nhập</label> 
										<input type="text" name="nameLogin" value=""
											placeholder="Username" id="nameLogin" class="form-control">
									</div>
									<div class="form-group">
										<label class="control-label" for="passLogin">Mật khẩu</label> 
										<input type="password" name="passLogin" value="" maxlength="10"
											placeholder="Password" id="passLogin" class="form-control"> 
									</div>
