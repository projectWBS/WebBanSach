						...
						if (strSearch != null) {
							...
							//kiem tra xem phai mang book khong
							{
								...
								for (int i = 0; i < searchBook.length; i++) {
									...
									out.println("<div class=\"button-arc forest right\" onclick=\"gotoPage('ViewBook?id="+ book.getMaSach() +"')\">");
									...
									out.println("<div class=\"button-arc cool right\" style=\"transform: translateY(150%)\">");
									...
									out.println("<li><div class=\"button-modify\">");
									out.println("<div class=\"button-arc danger right\" style=\"transform: translateY(300%)\">");
									out.println("<i class=\"fa fa-money\" onclick=\"buyNow('"+book.getMaSach()+"', 1)\"></i>");
									out.println(
											"<div class=\"content content-right\"><span>Mua ngay</span></div></div></div></li>");
									out.println("</ul></div>");
									out.println(
