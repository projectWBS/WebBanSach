		...
		<div class="bookshelf">
			<div class="row descrip">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
					<div class="title">
						<%
							Object objDanhMuc = request.getAttribute("danhMuc");
							String danhMuc = null;
							if (objDanhMuc != null && objDanhMuc instanceof String) {
								danhMuc = objDanhMuc.toString();
							}
							if (danhMuc != null) {
								out.println(danhMuc);
							}
			...
			<div class="row content">
				<%
					Object objBooks = request.getAttribute("danhSachSach");
					Book[] books = null;
					if (objBooks != null && objBooks instanceof Book[]) {
						books = (Book[]) objBooks;
					}
					if (books != null) {
